 ...
 */
public class SnowGirl extends JFrame implements GLEventListener,
...
//    String f = "src/fondos/paisaje.jpg";
    String paisaje = "src/fondos/paisaje.jpg";
    String paisaje2 = "src/fondos/paisaje2.jpg";
    String paisaje3 = "src/fondos/paisaje3.jpg";
    ...
    public static void main(String[] args)
    {
        ...
        canvas.addGLEventListener(new SnowGirl(0,0));
        frame.add(canvas);
    ...
    public void display(GLAutoDrawable drawable)
    {
        ...
        DibujaSnowGirl dsg = new DibujaSnowGirl();
        //mueve la escena
        ...
        //Fondo
//        dsg.cambiaFondo(gl, glu, t, f);
        texturaFondo(gl);
//        gl.glTranslated(0f, -0.65f, 0f);
        //  gl.glScalef(0.3f, 0.3f, 0f);
        //hacer tamano de toda la figura mas pequeno.
        gl.glScalef(0.85f, 0.85f, 0.85f);
        //gl.glScalef(-1f, -1f, -1f);
        dsg.dibujaBody(gl, glu, keys['J'], keys['W'], keys['S'], keys['R'],
